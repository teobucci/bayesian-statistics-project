...
#setwd("G:/.shortcut-targets-by-id/1Ck2MctcmCBWOueSMeW4Zr8IOvOaOzdqz/BicoccaDrive/Corsi/Statistical Modelling - Graphical Models")
...
```{r}
z_true = c(1,1,1,2,2,3,3,3,4,4)
counts_true = as.vector(table(z_true))
Nclust_true  = length(counts_true)

p = length(z_true)
n = 100
data_from_prior = Generate_data(n=n,p=p,z=z_true,seed=45679)
nu = n
data = data_from_prior$data
Omega_true = data_from_prior$Omega
