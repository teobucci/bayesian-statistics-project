...
#Computing random index for traceplot
#temporary horror
compute_random_index<-function(x,z_true=z_true){
    return (rand.index(x,z_true))
}
...
#rand_index = do.call(rbind, lapply(rand.index,z,z_true))
