...
%\definecolor{BG}{HTML}{689F38}
%\setbeamercolor{alerted text}{fg=Orange}
%\setbeamercolor{frametitle}{bg=BG}
...
%\titlegraphic{\includegraphics[scale=0.15]{../report/images/logo-polimi-transparent}}
\institute{Politecnico di Milano \\ Mathematical Engineering \\ Bayesian Statistics Project \\ A.Y. 2022/2023}
\date{\today}
