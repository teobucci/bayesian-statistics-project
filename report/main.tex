...
\newcommand{\schoolname}{Bayesian Statistics}
\newcommand{\schoolcode}{052499}
\newcommand{\schoolcoordinator}{Alessandro Colombi}%A. Guglielmi}
...
\title{
    ...
    \end{figure}
    \normalfont \normalsize 
    \textsc{Master of Science in Mathematical Engineering \\ 
    Project Report of \schoolname\ (\schoolcode) -- Prof. A. Guglielmi \\
    Tutor: \schoolcoordinator} \\
    [10pt] 
