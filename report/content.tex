...
\begin{enumerate}
    ...
    \[
        \frac{P(\bm{z}')}{P(\bm{z})} = \frac{(1-\sigma)_{(l)\uparrow} (1-\sigma)_{(n_{s}+n_{s+1}-l)\uparrow}}{(1-\sigma)_{(n_{s}-1)\uparrow} (1-\sigma)_{(n_{s+1}-1)\uparrow}}
        \cdot \frac{n_{s}! n_{s+1}!}{l!(n_{s} + n_{s+1} - l)!}
    \]
