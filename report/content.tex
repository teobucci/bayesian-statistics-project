...
\section{Sampling strategy}
We proposed a Block Gibbs sampling strategy divided into two main chunks: 
\begin{enumerate}
...
For this purpose, we modified the \texttt{R} package \texttt{BDgraph} to take into account the dependency from membership vector $\bm{z}$, updating the target distribution and the birth and death rates as follows: (TODO : dovremmo aggiungere i numeri alle formule?)
\[
...
\begin{align*}
    \frac{f_G(G \mid \rho^\prime)}{f_G(G \mid \rho)}
