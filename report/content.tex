...
\fg{0.7}{../output/data/simulation_01/indexes.pdf}
...
\hline
proposed & $C_1^\prime$ & $\ldots$ & \hspace*{0.5cm}$C_S^\prime$\hspace*{0.5cm} & \multicolumn{2}{|l|}{$C_{S+1}^\prime$}      & $\ldots$ & $C_{M+1}^\prime$\\
\hline
\end{tabular}
\end{table}
